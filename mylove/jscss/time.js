function showTime() { 
	...
	var startDate = Date.parse("2018/02/20 11:39");;
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear AnQin:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----Yours, TommyYang   2018-05-01</c>"; 
